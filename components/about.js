    ...
    return (
        <div className="bg-white dark:bg-black md:w-1/2 px-2 sm:px-4 py-2.5 flex flex-col justify-center items-center">
            ...
            <p className="font-sans p-4 dark:bg-white dark:text-black rounded-xl">
                ...
                </a>. Teams may consist of up to four participants, and previous coding experience is not required.
                <br /><br />
                ...
                The buzz around <a href="https://www.khanacademy.org/khan-labs" target="_blank" rel="noreferrer" className="underline">
                    ...
                    Chat-GPT
                </a> inspired us to organize our own event for students to innovate and create their own educational tools.
